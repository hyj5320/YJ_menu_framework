...
$(document).ready(function () {
    ...
    function closeAndRestSider() {
        if ($('#main-menu').attr('data-inner-menu') == '1') {
            ...
            console.log("closeAndRestSider 1111 " );
            ...
            console.log("closeAndRestSider 2222 closeAndRestSider" );
        }
    ...
    $('#layout-condensed-toggle').click(function () {
        ...
        if ($('#main-menu').attr('data-inner-menu') == '1') {
            ...
            if ($('#main-menu').hasClass('mini')) {
                ...
                if( $('#main-menu-sub').is(':visible') ) {
                	$('#inner-menu-sub').show(); //custom
                	 $('#inner-menu-sub').css({'left':'50px'});
                	console.log("inner-menu-sub 11111:");
                }
                
                
                console.log("Small 1111111111:");
            } else {
                $('body').addClass('grey');
                $('#main-menu').addClass('mini');
                ...
                if( $('#main-menu-sub').is(':visible') ) {
                	$('#inner-menu-sub').hide(); //custom
                	
                	console.log("inner-menu-sub l2222222222:");
                }
